...
import { Car, Calculator, CreditCard, Phone, Mail, CheckCircle } from "lucide-react"
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="max-w-2xl mx-auto text-center">
            <div className="mb-8">
              ...
              <h1 className="text-4xl font-bold text-foreground mb-4 font-sans">¡Cotización Enviada!</h1>
              <p className="text-xl text-muted-foreground font-serif">
                Hemos recibido tu solicitud de cotización. Nuestro equipo se pondrá en contacto contigo dentro de las
                próximas 2 horas.
              </p>
            </div>
            ...
            <Card className="mb-8">
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div>
                    <span className="text-muted-foreground font-serif">Nombre:</span>
                    <p className="font-medium font-serif">
                      {formData.firstName} {formData.lastName}
                    </p>
                  </div>
                  <div>
                    <span className="text-muted-foreground font-serif">Email:</span>
                    <p className="font-medium font-serif">{formData.email}</p>
                  </div>
                  <div>
                    <span className="text-muted-foreground font-serif">Tipo de vehículo:</span>
                    <p className="font-medium font-serif">{formData.vehicleType}</p>
                  </div>
                  <div>
                    <span className="text-muted-foreground font-serif">Presupuesto máximo:</span>
                    <p className="font-medium font-serif">${formData.maxPrice[0].toLocaleString()}</p>
                  </div>
                  {formData.financing && (
                    <>
                      <div>
                        <span className="text-muted-foreground font-serif">Enganche:</span>
                        <p className="font-medium font-serif">{formData.downPayment[0]}%</p>
                      </div>
                      <div>
                        <span className="text-muted-foreground font-serif">Pago mensual estimado:</span>
                        <p className="font-medium text-accent font-serif">${calculatedPayment}/mes</p>
                      </div>
                    </>
                  )}
                </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/inventario">
                <Button className="bg-accent hover:bg-accent/90 text-accent-foreground">Ver Inventario</Button>
              </Link>
              <Link href="/">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-8">
            <h1 className="text-4xl font-bold text-foreground mb-4 font-sans">Solicitar Cotización</h1>
            <p className="text-xl text-muted-foreground font-serif">
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription className="font-serif">
                      {step === 1 && "Cuéntanos sobre ti para personalizar tu cotización"}
                      {step === 2 && "¿Qué tipo de vehículo estás buscando?"}
                      {step === 3 && "Configuremos las opciones de pago"}
                      {step === 4 && "Últimos detalles para completar tu solicitud"}
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-6">
                        ...
                        <div>
                          ...
                          >
                            ...
                            <SelectContent>
                              ...
                              <SelectItem value="santiago">Santiago de Cuba</SelectItem>
                    ...
                    {step === 2 && (
                      <div className="space-y-6">
                        ...
                        <div>
                          <Label className="font-serif">Marca preferida (opcional)</Label>
                          <Select
                        ...
                        <div>
                          <Label className="font-serif">
                            Presupuesto máximo: ${formData.maxPrice[0].toLocaleString()}
                          </Label>
                          <Slider
                            value={formData.maxPrice}
                            onValueChange={(value) => setFormData({ ...formData, maxPrice: value })}
                            max={50000}
                            min={10000}
                            step={1000}
                            className="mt-2"
                      ...
                      <div className="space-y-6">
                        {formData.financing ? (
                          <>
                            <div>
                              <Label className="font-serif">
                                ...
                                {Math.round((formData.maxPrice[0] * formData.downPayment[0]) / 100).toLocaleString()})
                              </Label>
                              <Slider
                            ...
                            <div>
                              <Label className="font-serif">Plazo del préstamo</Label>
                              <Select
                            ...
                            {calculatedPayment > 0 && (
                              <div className="bg-accent/10 p-4 rounded-lg">
                                <h4 className="font-semibold text-accent mb-2 font-sans">Pago Mensual Estimado</h4>
                                <div className="text-3xl font-bold text-accent font-sans">${calculatedPayment}/mes</div>
                                <p className="text-sm text-muted-foreground mt-2 font-serif">
                                  *Estimación basada en tasa de interés del 8% anual. El pago final puede variar según
                            ...
                            {formData.tradeIn && (
                              <div>
                                <Label htmlFor="tradeInDetails" className="font-serif">
                          ...
                          <div className="text-center py-8">
                            ...
                            <h3 className="text-xl font-semibold text-foreground mb-2 font-sans">Pago de Contado</h3>
                            <p className="text-muted-foreground font-serif">
                              Has seleccionado pagar de contado. Esto puede darte acceso a mejores precios y promociones
                              especiales.
                            </p>
                          </div>
                        )}
                    ...
                    {step === 4 && (
                      <div className="space-y-6">
                        <div>
                          <Label htmlFor="additionalNotes" className="font-serif">
                        ...
                        <div>
                          <Label className="font-serif">¿Qué tan urgente es tu compra?</Label>
                          <Select
                          ...
                          >
                            ...
                            <SelectContent>
                              <SelectItem value="immediate">Inmediata (esta semana)</SelectItem>
                              <SelectItem value="soon">Pronto (este mes)</SelectItem>
                              <SelectItem value="planning">Planificando (próximos 3 meses)</SelectItem>
                              <SelectItem value="researching">Solo investigando</SelectItem>
                            </SelectContent>
                          </Select>
                        </div>
                      </div>
              ...
              <div className="space-y-6">
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    {formData.firstName && (
                      <div>
                        <span className="text-sm text-muted-foreground font-serif">Cliente:</span>
                        <p className="font-medium font-serif">
                          {formData.firstName} {formData.lastName}
                        </p>
                      </div>
                    ...
                    {formData.vehicleType && (
                      <div>
                        <span className="text-sm text-muted-foreground font-serif">Tipo de vehículo:</span>
                        <p className="font-medium font-serif">{formData.vehicleType}</p>
                      </div>
                    )}
                    ...
                    {formData.financing && calculatedPayment > 0 && (
                      <div>
                        <span className="text-sm text-muted-foreground font-serif">Pago mensual:</span>
                        <p className="font-medium text-accent font-serif">${calculatedPayment}/mes</p>
                      </div>
                    )}
                  </CardContent>
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    <p className="text-sm text-muted-foreground font-serif">
                      Nuestros expertos están disponibles para ayudarte con tu cotización.
                    </p>
                ...
                <Card>
                  <CardHeader>
                    <CardTitle className="font-sans">¿Por qué AutoCuba?</CardTitle>
                  </CardHeader>
                  <CardContent>
