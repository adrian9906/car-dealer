...
const availableVehicles = {
  toyota: [
    ...
    },
    {
      model: "Camry",
      year: "2023",
      image: "/toyota-camry-2023.png",
      basePrice: 28000,
    },
    {
      model: "RAV4",
      year: "2023",
      image: "/toyota-rav4-2023.png",
      basePrice: 32000,
    },
    {
      model: "Highlander",
      year: "2023",
      image: "/toyota-highlander-2023.png",
      basePrice: 38000,
    },
  ],
  honda: [
  ...
  ford: [
    ...
    },
    {
      model: "Mustang",
      year: "2023",
      image: "/ford-mustang-2023.png",
      basePrice: 32000,
    },
    {
      model: "Explorer",
      year: "2023",
      image: "/ford-explorer-2023.png",
      basePrice: 34000,
    },
    {
      model: "Escape",
      year: "2023",
      image: "/ford-escape-2023.png",
      basePrice: 26000,
    },
  ],
  chevrolet: [
    {
      model: "Silverado",
      year: "2023",
      image: "/chevrolet-silverado-2023.png",
      basePrice: 36000,
    },
    {
      model: "Tahoe",
    ...
    },
    {
      model: "Equinox",
      year: "2023",
      image: "/chevrolet-equinox-2023.png",
      basePrice: 28000,
    },
    {
      model: "Malibu",
      year: "2023",
      image: "/chevrolet-malibu-2023.png",
      basePrice: 25000,
    },
  ],
  nissan: [
          ...
          <div className="max-w-2xl mx-auto text-center">
            <div className="mb-8">
              ...
              <p className="text-xl text-muted-foreground font-serif">
                ...
                especializado se pondrá en contacto contigo dentro de las
                próximas 24 horas para comenzar el proceso.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-5xl md:text-6xl font-bold text-foreground mb-6 font-sans">
              Importación desde USA
            </h1>
            <p className="text-xl text-muted-foreground mb-8 font-serif leading-relaxed">
              Accede a miles de vehículos en Estados Unidos. Nosotros nos
              encargamos de todo el proceso de importación para que recibas tu
              auto en Cuba sin complicaciones.
            </p>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-3xl mx-auto">
              <div className="text-center">
                <div className="text-3xl font-bold text-accent mb-2 font-sans">
                  2000+
                </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                  ...
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription className="font-serif">
                        ...
                        {step === 3 &&
                          "Últimos detalles para personalizar tu importación"}
                      </CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-6">
                      ...
                      {step === 3 && (
                        <div className="space-y-6">
                          <div>
                            <Label className="font-serif">
                              ¿Qué tan urgente es tu importación?
                            </Label>
                            <Select
                            ...
                            >
                              ...
                              <SelectContent>
                                <SelectItem value="immediate">
                                  Inmediata (proceso express)
                                </SelectItem>
                                <SelectItem value="normal">
                                  Normal (4-6 semanas)
                                </SelectItem>
                                <SelectItem value="flexible">
                                  Flexible (cuando encuentres el mejor precio)
                                </SelectItem>
                              </SelectContent>
                            </Select>
                          </div>
                ...
                <div className="space-y-6">
                  ...
                  <Card>
                    ...
                    <CardContent className="space-y-4">
                      <p className="text-sm text-muted-foreground font-serif">
                        Nuestros especialistas en importación están disponibles
                        para ayudarte.
                      </p>
                      <div className="space-y-2">
                        <Button
