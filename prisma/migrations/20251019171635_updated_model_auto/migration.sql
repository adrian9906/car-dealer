/*
  ...
  - Added the required column `category` to the `auto` table without a default value. This is not possible if the table is not empty.
  - Added the required column `stock` to the `auto` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_auto" ("año", "color", "createdAt", "estado_auto", "fecha_llegada_cuba", "id_auto", "id_cliente_propietario", "id_importacion", "id_importacion_cliente", "id_proveedor", "kilometraje", "marca", "matricula_cubana", "modelo", "precio_compra", "precio_venta", "tipo_combustible", "tipo_propiedad", "transmision", "updatedAt", "vin") SELECT "año", "color", "createdAt", "estado_auto", "fecha_llegada_cuba", "id_auto", "id_cliente_propietario", "id_importacion", "id_importacion_cliente", "id_proveedor", "kilometraje", "marca", "matricula_cubana", "modelo", "precio_compra", "precio_venta", "tipo_combustible", "tipo_propiedad", "transmision", "updatedAt", "vin" FROM "auto";
DROP TABLE "auto";
